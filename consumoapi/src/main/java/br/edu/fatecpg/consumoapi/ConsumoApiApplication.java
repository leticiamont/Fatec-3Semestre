...
public class ConsumoApiApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		while(loop) {
			System.out.println();
			System.out.println("1 - Consulte o CEP desejado");
			System.out.println("2 - Consultar todos os CEPs cadastrados");
			...
			case 1:
				...
				try {
					...
					System.out.println("CEP correto e armazenado com sucesso!");
				}
				break;
